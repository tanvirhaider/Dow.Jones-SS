...
var adData = {
  ...
  // "panthere", "santos"
  panthere: {
    headlines: [// "PANTHÈRE DE CARTIER WATCH", 
    "PANTHÈRE DE CARTIER WATCH", "PANTHÈRE DE CARTIER WATCH", //  "PANTHÈRE DE CARTIER WATCH", 
    //  "PANTHÈRE DE CARTIER WATCH", 
    "PANTHÈRE DE CARTIER WATCH"],
    summaries: [// "DOUBLE LOOP, YELLOW GOLD", 
    "RHODIUMIZED 18K WHITE GOLD", "PINK GOLD, DIAMONDS", // "PINK GOLD, DIAMONDS", 
    // "RHODIUMIZED WHITE GOLD, DIAMONDS", 
    "MINI, YELLOW GOLD"],
    images: [//  "assets/images/panthere-0.png", 
    "assets/images/panthere-1.png", "assets/images/panthere-2.png", //  "assets/images/panthere-3.png", 
  ...
  santos: {
    headlines: ["SANTOS DE CARTIER WATCH", // "SANTOS DE CARTIER WATCH", 
    "SANTOS DE CARTIER WATCH", //  "SANTOS DE CARTIER WATCH", 
    "SANTOS DE CARTIER WATCH"],
    summaries: ["LARGE MODEL, AUTOMATIC, PINK GOLD", // "MEDIUM MODEL, AUTOMATIC, YELLOW GOLD", 
    "MEDIUM MODEL, AUTOMATIC, YELLOW GOLD", // "MEDIUM MODEL, AUTOMATIC, YELLOW GOLD AND STEEL", 
    "SMALL MODEL, 18K PINK GOLD AND STEEL"],
    images: ["assets/images/santos-0.png", // "assets/images/santos-1.png", 
    "assets/images/santos-2.png", // "assets/images/santos-3.png", 
...
function init(all) {
  ...
  var navCopy = new Sprite({
    ...
    container: nav.obj,
    text: {
      content: slideTrackerInt + " of " + totalSlideCount
    }
  });
  ...
  function dummyTracking() {
    ...
    window.EB.userActionCounter("view-product-2"); //window.EB.userActionCounter("view-product-3");
    ...
    window.EB.clickthrough("product-2"); //window.EB.clickthrough("product-3");
  ...
  function ctaClicked(event) {
    ...
    if (slideTrackerInt == 4) {
      tempCTAindex = 3;
    }

    if (slideTrackerInt == 2) {
      tempCTAindex = 1;
    }

    if (slideTrackerInt == 3) {
      tempCTAindex = 2;
    }
